<template>
  <div class="">
    <div class="container mx-auto pt-16 placeholder-black w-full max-w-xs">
      <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="flex items-center justify-between">
          ...
          <nuxt-link class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" to="/forgot">
            Forgot Password?
          </nuxt-link>
        </div>
      </form>
